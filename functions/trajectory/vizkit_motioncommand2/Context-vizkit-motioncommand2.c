...
{
    *pVal = (asn1SccContext_vizkit_motioncommand2) {
    .configfile = "",
    .id = " "
};
}
...
flag asn1SccContext_vizkit_motioncommand2_IsConstraintValid(const asn1SccContext_vizkit_motioncommand2* pVal, int* pErrCode)
{
...
const asn1SccContext_vizkit_motioncommand2 vizkit_motioncommand2_ctxt = {
