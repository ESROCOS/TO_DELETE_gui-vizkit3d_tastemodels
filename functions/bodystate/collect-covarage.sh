...
then
    ...
    lcov --remove coverage_filtered.info \
         $PWD/binary.c/test_bodystate/test_bodystate/* \
    ...
    lcov --extract coverage_noglue.info \
        $PWD/binary.c/vizkit_bodystate/vizkit_bodystate/vizkit_bodystate.c \
        $PWD/binary.c/vizkit_rigidbodystate/vizkit_rigidbodystate/vizkit_rigidbodystate.c \
