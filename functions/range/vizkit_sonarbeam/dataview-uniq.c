...
flag asn1SccPose_IsConstraintValid(const asn1SccPose* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = asn1SccPosition_IsConstraintValid(&pVal->a_position, pErrCode);
	if (ret) {
	    ret = asn1SccOrientation_IsConstraintValid(&pVal->a_orientation, pErrCode);
...
{
    *pVal = (asn1SccRotationLUT) {
    .resolution = 0,
    .rad2deg = 0.00000000000000000000E+000,
    .deg2rad = 0.00000000000000000000E+000,
    .transformations = -2147483648LL
};
}
#endif

 
flag asn1SccRotationLUT_IsConstraintValid(const asn1SccRotationLUT* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = asn1SccT_UInt32_IsConstraintValid(&pVal->resolution, pErrCode);
	if (ret) {
	    ret = asn1SccT_Double_IsConstraintValid(&pVal->rad2deg, pErrCode);
	    if (ret) {
	        ret = asn1SccT_Double_IsConstraintValid(&pVal->deg2rad, pErrCode);
	        if (ret) {
	            ret = asn1SccT_Int32_IsConstraintValid(&pVal->transformations, pErrCode);
