...
{
    *pVal = (asn1SccContext_vizkit_trajectory2) {
    .configfile = "",
    .id = " "
};
}
...
flag asn1SccContext_vizkit_trajectory2_IsConstraintValid(const asn1SccContext_vizkit_trajectory2* pVal, int* pErrCode)
{
...
const asn1SccContext_vizkit_trajectory2 vizkit_trajectory2_ctxt = {
