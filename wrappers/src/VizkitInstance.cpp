                    ...
                    try
                    {
                        ...
                        else 
                        {
                            ...
                            msg << "unknown plugin type " << type << "; expected values are: "
                                ...
                                "BodyStatePluginController, "
                                "DepthMapPluginController, "
                                "GridPluginController, "
                                "LaserScanPluginController, "
                                "ModelPluginController, "
                                "MotionCommandPluginController, "
                                "PluginController, "
                                "PointcloudPluginController, "
                                "RigidBodyStatePluginController, "
                                "SonarBeamPluginController, "
                                "TextureBoxPluginController, "
                                "TrajectoryPluginController, "
                                "WaypointPluginController";
                            printMsg(msg.str());
                        }
                    }
                    catch (const std::exception& e)
