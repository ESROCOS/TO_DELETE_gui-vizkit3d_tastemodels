 ...
 * ---------------------------------------------------------------------
 * A class with static methods to read vizkit-taste configuration 
 * parameters from a YAML configuration (implementation).
 * ---------------------------------------------------------------------
 * HISTORY
 * $History$
 * ================================================================== */
    ...
    std::string& outValue, YAML::Node& cfgNode, const std::string& name, const std::string& labelId)
{
    ...
    {
        std::cerr << "vizkit-taste: wrong value for \"" << name << "\" in " << labelId << std::endl;
        return false;
    }
    ...
    std::vector<double>& outValue, size_t size, YAML::Node& cfgNode, const std::string& name, const std::string& labelId)
{
    ...
    {
        std::cerr << "vizkit-taste: wrong value for \"" << name << "\" in " << labelId 
    ...
    else
    {
        ...
        for (size_t i = 0; i < size; i++)
        {
            ...
            {
                std::cerr << "vizkit-taste: wrong element \"" << name << "\" in " << labelId 
    ...
    QColor& outValue, YAML::Node& cfgNode, const std::string& name, const std::string& labelId)
{
    try
    {
        ...
        {
            std::cerr << "vizkit-taste: wrong value for \"" << name << "\" in " << labelId << " plugin, "
...
{
    std::cerr << "vizkit-taste: unknown configuration parameter \"" << name << "\" in " << labelId << std::endl;
}

void ConfigurationReader::printMsg(const std::string& msg)
{
    std::cerr << "vizkit-taste: " << msg << std::endl;
}

void ConfigurationReader::printMsg(const std::string& msg, const std::string& param)
{
    std::cerr << "vizkit-taste: " << msg << param << std::endl;
}
